...
credentials_block = GcpCredentials(service_account_info=sa)
credentials_block.save("mlops-project-sa", overwrite=True)

# DEPLOYMENT BLOCK
bucket_storage = GCS(
    service_account_info=json.dumps(sa),
    bucket_path="mlops-zoomcamp-project-prefect-code-1234",
)
bucket_storage.save("mlops-project-deployment", overwrite=True)
